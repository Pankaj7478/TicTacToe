...
export const handleMove = (move,arr,data,rdata) => {
    let randomIndex=10;
    ...
    if(move===1){
        if(arr[0]!=4)randomIndex=4;
        else randomIndex=0;
    }
    if(move===2){
        if(arr[0]===0){
            if(data[3]||data[5]||data[6]||data[7]||data[8])randomIndex=2;
            if(data[4])randomIndex=8;if(data[1]||data[2])randomIndex=6;
        }
        else if(arr[0]===2){
            if(data[0]||data[1]||data[3]||data[6]||data[7])randomIndex=8;
            if(data[4])randomIndex=6;if(data[5]||data[8])randomIndex=0;
        }
        else if(arr[0]===6){
            if(data[0]||data[1]||data[2]||data[3]||data[5])randomIndex=8;
            if(data[4])randomIndex=2;if(data[7]||data[8])randomIndex=0;
        }
        else if(arr[0]===8){
            if(data[0]||data[1]||data[2]||data[3]||data[5])randomIndex=6;
            if(data[4])randomIndex=0;if(data[6]||data[7])randomIndex=2;
        }
        else if(arr[0]===1||arr[0]===3||arr[0]===5||arr[0]===7){
            const rand=[0,2,6,8];randomIndex=rand[Math.floor(rand.length*Math.random())];
        }
    }
    else if(move===3){
        ...
        if ((data[0] === data[8] && data[8] )||(data[2] === data[6] && data[6] )) {
            ...
            if(data[0])randomIndex=2;else randomIndex=0;
        }
        else if((data[1] && data[7] && data[7] === rdata[0][0])||(data[3] && data[5] && data[3] === rdata[0][0])) {
        ...
        if(arr[0]===4){
            if(arr[1]===0)randomIndex=8;if(arr[1]===2)randomIndex=6;
            if(arr[1]===6)randomIndex=2;if(arr[1]===8)randomIndex=0;
        }
    ...
    randomIndex=winmove(data,rdata,randomIndex);
    return randomIndex;
  };
